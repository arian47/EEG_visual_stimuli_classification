...
def create_paths():
    ...
    vis_stim_aio_path_base = x
    mus_stim_aio_path_base = x
    eye_stim_aio_path_base = x
    vis_stim_aio_path = vis_stim_aio_path_base.joinpath('visual_stimuli_ersps_in_one.npy')
    mus_stim_aio_path = mus_stim_aio_path_base.joinpath('muscle_stimuli_ersps_in_one.npy')
    eye_stim_aio_path = eye_stim_aio_path_base.joinpath('eyes_stimuli_ersps_in_one.npy')
    vis_stim_aio_labels_path = vis_stim_aio_path_base.joinpath('visual_stimuli_ersps_in_one_labels.npy')
    mus_stim_aio_labels_path = mus_stim_aio_path_base.joinpath('muscle_stimuli_ersps_in_one_labels.npy')
    eye_stim_aio_labels_path = eye_stim_aio_path_base.joinpath('eyes_stimuli_ersps_in_one_labels.npy')


    # file paths which contain the ersps for subjects with strong gamma response only needed for classification later
    vis_stim_strong_gamma_path_base = x
    mus_stim_strong_gamma_path_base = x
    eye_stim_strong_gamma_path_base = x
    vis_stim_strong_gamma_path = vis_stim_strong_gamma_path_base.joinpath('vis_stim_strong_gamma_response_subjects.npy')
    mus_stim_strong_gamma_path = mus_stim_strong_gamma_path_base.joinpath('mus_stim_strong_gamma_response_subjects.npy')
    eye_stim_strong_gamma_path = eye_stim_strong_gamma_path_base.joinpath('eye_stim_strong_gamma_response_subjects.npy')
    vis_stim_strong_gamma_labels_path = vis_stim_strong_gamma_path_base.joinpath('vis_stim_strong_gamma_response_subjects_labels.npy')
    mus_stim_strong_gamma_labels_path = mus_stim_strong_gamma_path_base.joinpath('mus_stim_strong_gamma_response_subjects_labels.npy')
    eye_stim_strong_gamma_labels_path = eye_stim_strong_gamma_path_base.joinpath('eye_stim_strong_gamma_response_subjects_labels.npy')
    ...
    mus_stim_aio_path_base = x
    eye_stim_aio_path_base = x
    vis_stim_aio_average_td_fh_path = vis_stim_aio_path_base.joinpath('visual_stimuli_ersps_in_one_average_td_first_half.npy')
    vis_stim_aio_average_td_sh_path = vis_stim_aio_path_base.joinpath('visual_stimuli_ersps_in_one_average_td_second_half.npy')
    vis_stim_aio_average_td_path = vis_stim_aio_path_base.joinpath('visual_stimuli_ersps_in_one_average_td.npy')
    mus_stim_aio_average_td_path = mus_stim_aio_path_base.joinpath('muscle_stimuli_ersps_in_one_average_td.npy')
    eye_stim_aio_average_td_path = eye_stim_aio_path_base.joinpath('eyes_stimuli_ersps_in_one_average_td.npy')
    ...
    paths_info_dict = dict(
        ...
        eye_stim_aio_path=mus_stim_aio_path,
