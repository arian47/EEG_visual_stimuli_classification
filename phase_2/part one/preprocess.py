...
def create_arrays(info_dict):
    subjects_path_dict = info_dict.get('subjects_path_dict')
    s1_vis_shape = info_dict.get('s1_vis_shape')
    ...
    s1_mus_shape = info_dict.get('s1_mus_shape')
    ...
    s1_eye_shape = info_dict.get('s1_eye_shape')
    eye_stim_aio_path = info_dict.get('eye_stim_aio_path')
    strong_gamma_response_subjects_data_dir_path_dict = info_dict.get('strong_gamma_response_subjects_data_dir_path_dict')
    ...
    subjects_of_interest = info_dict.get('subjects_of_interest')
    ...
    numpy.save(vis_stim_aio_path, visual_stimuli_ersps_in_one)
    del visual_stimuli_ersps_in_one, baseline_corrected_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, subject_ersp_ndarray, subject_mat_path_vis
    ...
    visual_stimuli_ersps_in_one_average_td.shape
    ...
    numpy.save(vis_stim_aio_average_td_path, visual_stimuli_ersps_in_one_average_td)
    del visual_stimuli_ersps_in_one_average_td, baseline_corrected_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, subject_ersp_ndarray, subject_mat_path_vis
    ...
    numpy.save(vis_stim_aio_average_td_fh_path, visual_stimuli_ersps_in_one_average_td_fh)
    del visual_stimuli_ersps_in_one_average_td_fh, baseline_corrected_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, subject_ersp_ndarray, subject_mat_path_vis
    ...
    numpy.save(mus_stim_aio_path, muscle_stimuli_ersps_in_one)
    del muscle_stimuli_ersps_in_one, baseline_corrected_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, subject_ersp_ndarray, subject_mat_path_mus
    ...
    numpy.save(vis_stim_aio_average_td_sh_path, visual_stimuli_ersps_in_one_average_td_sh)
    del visual_stimuli_ersps_in_one_average_td_sh, baseline_corrected_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, subject_ersp_ndarray, subject_mat_path_vis
    ...
    numpy.save(eye_stim_aio_path, eyes_stimuli_ersps_in_one)
    del eyes_stimuli_ersps_in_one, baseline_corrected_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, subject_ersp_ndarray, subject_mat_path_eye
    ...
    del visual_stimuli_ersps_aio_strong_gamma_subjects, subject_mat_path_vis, subject_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, baseline_corrected_ersp_ndarray
    ...
    del muscle_stimuli_ersps_aio_strong_gamma_subjects, subject_mat_path_mus, subject_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, baseline_corrected_ersp_ndarray 
    ...
    del eyes_stimuli_ersps_aio_strong_gamma_subjects, subject_mat_path_eye, subject_ersp_ndarray, subject_ersp_ndarray_mean_over_specific_timepoints, baseline_corrected_ersp_ndarray
